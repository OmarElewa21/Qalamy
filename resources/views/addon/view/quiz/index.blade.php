...
@section('content')
    ...
    <div class="card m-b-30">
        <h4 style="{{(App::isLocale('ar') ? 'text-align:right' : '')}}" class="card-header">@translate(Create New Quiz)</h4>
        <div class="card-body mx-3">
            <form action="{{route('quiz.store')}}" method="post"  enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div style="{{(App::isLocale('ar') ? 'text-align:right' : '')}}" class="form-group col-md-6 p-3">
                    ...
                    <div style="{{(App::isLocale('ar') ? 'text-align:right' : '')}}" class="form-group col-md-4 p-3">
                ...
                <button style="{{(App::isLocale('ar') ? 'float:right' : '')}}" class="btn btn-outline-success" type="submit"> @translate(Submit)</button>
            </form>
        </div>
    </div>
    <!-- END:content -->
    @if(request()->is('dashboard/quiz/list'))
        <div class="card m-b-30">
            <h4 style="{{(App::isLocale('ar') ? 'text-align:right' : '')}}" class="card-header">@translate(All Quiz)</h4>
            <div class="card-body mx-3">
