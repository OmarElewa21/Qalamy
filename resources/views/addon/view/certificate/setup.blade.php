...
@section('content')
    ...
    <div class="card m-b-30">
        <h4 class="card-header" style="{{(App::isLocale('ar') ? 'text-align:right' : 'text-align:left')}}">@translate(Certificate Template Text)</h4>
        @if($certificate != null)
        <div class="text-right">
            <a href="{{route('demo.certificate')}}" target="_blank" class="nav-link">@translate(show demos)</a>
        </div>
        @endif
        <div class="card-body mx-3" dir="{{(App::isLocale('ar') ? 'rtl' : 'ltr')}}">
                @csrf
            <div class="form-group p-3">
                <label style="{{(App::isLocale('ar') ? 'float:right' : 'float:left')}}" class="" for="val-title">@translate(Certificate Template Top Text) <span
            ...
            <div class="form-group p-3">
                <label style="{{(App::isLocale('ar') ? 'float:right' : 'float:left')}}" class="" for="val-title">@translate(Certificate Template Header Text) <span
                        class="text-danger">*</span></label><br>
                <div class="">
            ...
            <div class="form-group p-3">
                <label style="{{(App::isLocale('ar') ? 'float:right' : 'float:left')}}" class="" for="val-title">@translate(Certificate Template Footer Text) <span
                        class="text-danger">*</span></label><br>
                <div class="">
                ...
                <div class="form-group p-3">
                    <label style="{{(App::isLocale('ar') ? 'float:right' : 'float:left')}}" class="" for="val-title">@translate(Certificate Template Text) <span
                            class="text-danger">*</span></label><br>
                ...
                <div class="form-group">
                    <label style="{{(App::isLocale('ar') ? 'float:right' : 'float:left')}}" class="" for="val-title">@translate(Generate Barcode for Certificate) <span
                            class="text-danger">*</span></label><br>
                    <small>N.B: Print Barcode in Certificate</small>
                    <select style="{{(App::isLocale('ar') ? 'float:right' : 'float:left')}}" class="select2" name="permissions" required>
                ...
                <button style="{{(App::isLocale('ar') ? 'float:right' : 'float:left')}}" class="btn btn-outline-success" type="submit">@translate(Save)</button>
    ...
    <!-- END:content -->
        ...
        <div class="card m-b-30" dir="{{(App::isLocale('ar') ? 'rtl' : 'ltr')}}">
            <h4 class="card-header" style="{{(App::isLocale('ar') ? 'text-align:right' : 'text-align:left')}}">@translate(Certificate Badge)</h4>
        ...
        <div class="card m-b-30" dir="{{(App::isLocale('ar') ? 'rtl' : 'ltr')}}">
            <h4 class="card-header" style="{{(App::isLocale('ar') ? 'text-align:right' : 'text-align:left')}}">@translate(Certificate Logo)</h4>
            <div class="card-body mx-3">
                <div class="row">
                    <div class="col-md-6">
    ...
    <div class="card m-b-30" dir="{{(App::isLocale('ar') ? 'rtl' : 'ltr')}}">
        <h4 class="card-header" style="{{(App::isLocale('ar') ? 'text-align:right' : 'text-align:left')}}">@translate(Certificate Template)</h4>
        <div class="card-body mx-3">
            <div class="row">
                <div class="col-md-6">
                    <label>
