        ...
        <div class="col-md-10 offset-md-1 px-5">
            <div class="card m-2">
                <div class="card-header">
                    <h3 style="{{(App::isLocale('ar') ? 'float:right;' : 'float:left;')}}">@translate(Affiliate  Setting)</h3>
                </div>
                <div class="card-body mx-5">
                    ...
                    <!--commission-->
                        <label  style="{{(App::isLocale('ar') ? 'float:right;' : 'float:left;')}}"class="label">@translate(Affiliate commission)</label>
                        ...
                        <!--withdraw_limit-->
                        <label style="{{(App::isLocale('ar') ? 'float:right;' : 'float:left;')}}" class="label">@translate(Withdraw Limit)</label>
                        ...
                        <!--cookies_limit-->
                        <label style="{{(App::isLocale('ar') ? 'float:right;' : 'float:left;')}}" class="label">@translate(Cookies Limit)(@translate(day))</label>
