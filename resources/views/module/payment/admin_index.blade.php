...
@section('content')
    <div class="card" dir="{{(App::isLocale('ar') ? 'rtl' : 'ltr')}}">
        <div class="card-header bg-white">
            ...
            <div class="{{(App::isLocale('ar') ? 'float-left' : 'float-right')}} d-flex justify-content-around">
                <div class="my-auto mr-5"><h2 class="card-title">@translate(Filter by instructor)</h2></div>
