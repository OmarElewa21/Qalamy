<div class="card-body" style="{{(App::isLocale('ar') ? 'text-align:right' : '')}}">
    <h3><b>@translate(Your Current Balance is) : {{formatPrice($instructor->balance)}}</b></h3>
    <form action="{{route('payments.store')}}" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input class="form-control" type="number" min="10" max="{{$instructor->balance}}" name="amount" required>
        </div>
        <div class="form-group">
