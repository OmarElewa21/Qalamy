    ...
    <form action="{{route('categories.store')}}" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <div class="custom-file">
                ...
                @if (MediaActive())
                    {{-- media --}}
                    <a href="javascript:void(0)" onclick="openNav('{{ route('media.slide') }}', 'category')" class="btn btn-primary media-btn mt-2 p-2">@translate(Upload From Media) <i class="fa fa-cloud-upload ml-2" aria-hidden="true"></i> </a>
                @endif
