                ...
                <div class="tab-content {{(App::isLocale('ar') ? 'text-right' : '')}}" id="v-pills-tabContent">
                    <div class="tab-pane fade show active" id="v-pills-crm" role="tabpanel"
                        ...
                        <ul class="vertical-menu">
                            <li><a href="{{route('dashboard')}}" style="{{(App::isLocale('ar') ? 'text-align:right' : '')}}">
                                ...
                                <li class="{{request()->is('dashboard/user*')
                                   ...
                                   || request()->is('dashboard/instructor*')
                                    ...
                                    <a style="{{(App::isLocale('ar') ? 'text-align:right' : '')}}" href="javaScript:void();">
                                        ...
                                        <span>@translate(User Management)</span><i style="{{(App::isLocale('ar') ? 'float:left' : '')}}"
                            ...
                            <li class="{{request()->is('dashboard/course*')
                                ...
                                <a style="{{(App::isLocale('ar') ? 'text-align:right' : '')}}" href="javaScript:void();">
                                    ...
                                    <span>@translate(Courses) @if(\Illuminate\Support\Facades\Auth::user()->user_type == "Admin")
                                        ...
                                        <i style="{{(App::isLocale('ar') ? 'float:left' : '')}}"
                                        class="{{(App::isLocale('ar') ? 'feather icon-chevron-left' : 'feather icon-chevron-right')}}"></i>
                                </a>
                                <ul class="vertical-submenu">
                                    @if(\Illuminate\Support\Facades\Auth::user()->user_type != "Admin")
                        ...
                        {{-- Coupon manager --}}
                            @if (couponActive() && \Illuminate\Support\Facades\Auth::user()->user_type == "Admin")
                                ...
                                <li class="{{request()->is('dashboard/coupon*')
                                    ? 'active' : null}}">
                                    <a style="{{(App::isLocale('ar') ? 'text-align:right' : '')}}" href="javascript:;">
                                        <i class="fa fa-bullhorn"></i>
                                        <span>@translate(Coupon Manager)</span><i style="{{(App::isLocale('ar') ? 'float:left' : '')}}"
                                        class="{{(App::isLocale('ar') ? 'feather icon-chevron-left' : 'feather icon-chevron-right')}}"></i>
                                    </a>
                                    <ul class="vertical-submenu">
                                        <li>
                            ...
                            @if (zoomActive() && \Illuminate\Support\Facades\Auth::user()->user_type != "Admin")
                                ...
                                <li class="{{request()->is('dashboard/zoom*')
                                    ...
                                    <a style="{{(App::isLocale('ar') ? 'text-align:right' : '')}}" href="javaScript:void();">
                                        ...
                                        <span>@translate(Zoom Meeting)</span><i style="{{(App::isLocale('ar') ? 'float:left' : '')}}"
                                        class="{{(App::isLocale('ar') ? 'feather icon-chevron-left' : 'feather icon-chevron-right')}}"></i>
                                    </a>
                                    <ul class="vertical-submenu">
                                        <li>
                            ...
                            @if(\Illuminate\Support\Facades\Auth::user()->user_type == "Admin" && certificate())
                                <li><a style="{{(App::isLocale('ar') ? 'text-align:right' : '')}}" href="{{route('certificate.setup')}}"
                            ...
                            @if(\Illuminate\Support\Facades\Auth::user()->user_type == "Admin")
                                {{-- Package area --}}
                                <li><a style="{{(App::isLocale('ar') ? 'text-align:right' : '')}}" href="{{route('packages.index')}}"
                                       class="{{request()->is('dashboard/package*') ?'active':null}}">
                                        <i class="fa fa-briefcase"></i> <span>@translate(Instructor Package)</span></a>
                                </li>

                                <li><a style="{{(App::isLocale('ar') ? 'text-align:right' : '')}}" href="{{route('payments.index')}}"
                            ...
                            @if(\Illuminate\Support\Facades\Auth::user()->user_type == "Instructor")
                                ...
                                {{-- Comment in Course --}}
                                <li><a style="{{(App::isLocale('ar') ? 'text-align:right' : '')}}" href="{{route('comments.index')}}"
                                ...
                                <li><a style="{{(App::isLocale('ar') ? 'text-align:right' : '')}}" href="{{route('instructor.earning')}}"
                                       class="{{request()->is('dashboard/instructor*') ?'active':null}}">
                                        <i style="{{(App::isLocale('ar') ? 'text-align:right' : '')}}"  class="fa fa-history"></i> <span>@translate(Earning History)</span>
                                    </a>
                                </li>
                            ...
                            @if(\Illuminate\Support\Facades\Auth::user()->user_type == "Admin")
                                {{-- Admin Earning area --}}
                                <li><a style="{{(App::isLocale('ar') ? 'text-align:right' : '')}}" href="{{route('admin.earning.index')}}"
                            ...
                            {{-- Support Ticket --}}
                            <li><a style="{{(App::isLocale('ar') ? 'text-align:right' : '')}}" href="{{route('tickets.index')}}"
                            ...
                            <li class="{{request()->is('dashboard/smtp*')
                                ...
                                <a style="{{(App::isLocale('ar') ? 'text-align:right' : '')}}" href="javaScript:void();">
                                    ...
                                    <span>@translate(Settings)</span><i style="{{(App::isLocale('ar') ? 'float:left' : '')}}"
                                        class="{{(App::isLocale('ar') ? 'feather icon-chevron-left' : 'feather icon-chevron-right')}}"></i></i>
                                </a>
                                <ul class="vertical-submenu">
                                    @if(\Illuminate\Support\Facades\Auth::user()->user_type == "Admin")
                            ...
                            @if(env('ADDONS_MANAGER') == "YES")
                                ...
                                @if(Auth::user()->user_type === "Admin")
                                    ...
                                    {{-- Addons manager --}}
                                    <li><a style="{{(App::isLocale('ar') ? 'text-align:right' : '')}}" href="{{route('addons.manager.index')}}"
                            ...
                            @if(env('THEME_MANAGER') == "YES")
                                @if(Auth::user()->user_type === "Admin")
                                    {{-- THEME manager --}}
                                    <li><a style="{{(App::isLocale('ar') ? 'text-align:right' : '')}}" href="{{route('theme.manager.index')}}"
