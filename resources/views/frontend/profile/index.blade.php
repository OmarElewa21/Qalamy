    ...
    <section class="dashboard-area">
        ...
        <div class="dashboard-content-wrap">
            <div class="container-fluid">
                        ...
                        <div
                            ...
                            <div class="user-bread-content d-flex align-items-center">
                                ...
                                <div class="section-heading">
                                    ...
                                    {{-- WALLET --}}
                                    {{-- @includeIf('wallet.frontend.profile_balance') There is a problem in this line --}}
                                </div>
                            </div>
                ...
                <div class="row mt-5">
                    <div class="col-lg-12" style="{{(App::isLocale('ar') ? 'text-align:center' : '')}}">
                        <h3 class="widget-title">@translate(My Profile)</h3>
                    </div>
                </div>
                <div class="row mt-5">
                    <div class="col-lg-8">
                        <div class="profile-detail pb-5" dir="{{(App::isLocale('ar') ? 'rtl' : 'ltr')}}">
                            <ul class="list-items" style="{{(App::isLocale('ar') ? 'text-align:right' : '')}}">
