                ...
                @error('image') <span class="invalid-feedback" role="alert"> <strong>{{ $message }}</strong> </span> @enderror
                 ...
                 <img class="package_preview rounded shadow-sm d-none" width="60" src="" alt="#Package thumbnail">  
                    ...
                    <br>
                      ...
                      @if (MediaActive())
                       {{-- media --}}
                      <a href="javascript:void()" onclick="openNav('{{ route('media.slide') }}', 'package')" class="btn btn-primary media-btn mt-2 p-2">@translate(Upload From Media) <i class="fa fa-cloud-upload ml-2" aria-hidden="true"></i> </a>
                      @endif
