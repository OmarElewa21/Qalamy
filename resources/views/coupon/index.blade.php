...
<div class="card" dir="{{(App::isLocale('ar') ? 'rtl' : 'ltr')}}">

    <div class="card-header" style="{{(App::isLocale('ar') ? 'text-align:right' : 'text-align:left')}}">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{route('coupon.store')}}" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label style="{{(App::isLocale('ar') ? 'float:right' : 'float:left')}}">@translate(Coupon Code)</label>
                                <input type="text" name="code" value="{{ old('code') }}" class="form-control"
                                    placeholder="@translate(Coupon Code)" required>
                            </div>

                            <div class="form-group">
                                <label style="{{(App::isLocale('ar') ? 'float:right' : 'float:left')}}">@translate(Discount Amount)</label>
                            ...
                            <div class="form-group">
                                <label style="{{(App::isLocale('ar') ? 'float:right' : 'float:left')}}">@translate(Starting Date)</label>
                            ...
                            <div class="form-group">
                                <label style="{{(App::isLocale('ar') ? 'float:right' : 'float:left')}}">@translate(Ending Date)</label>
                            ...
                            <div class="form-group">
                                <label style="{{(App::isLocale('ar') ? 'float:right' : 'float:left')}}">@translate(Minimum Shopping Amount)</label>
                            ...
                            <div class="form-group">
                                ...
                                <label style="{{(App::isLocale('ar') ? 'float:right' : 'float:left')}}" for="published">@translate(Is published?)</label>
                            </div>

                            <button style="{{(App::isLocale('ar') ? 'float:right' : 'float:left')}}" type="submit" class="btn btn-primary">@translate(Submit)</button>
