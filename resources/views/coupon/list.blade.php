...
<div class="card" dir="{{(App::isLocale('ar') ? 'rtl' : 'ltr')}}">
    ...
    <div class="card-header">
        <span style="{{(App::isLocale('ar') ? 'float:right' : 'float:left')}}" class="h1 card-title">@translate(Coupon Manager)</span>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card-body">
                        ...
                        <div class="card">
        <div class="card-header">
            <h3 style="{{(App::isLocale('ar') ? 'float:right' : 'float:left')}}" class="card-title">@translate(Coupon Informations)</h3>
        </div>
