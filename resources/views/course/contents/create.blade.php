                ...
                <div class="col-lg-9">
                    ...
                    @if (MediaActive())
                        ...
                        <a href="javascript:void()" onclick="openNav('{{ route('media.slide') }}', 'file')"
                           class="btn btn-primary media-btn d-none mt-2 p-2">@translate(Upload From Media) <i
            ...
            <div class="col-lg-9">
                ...
                @if (MediaActive())
                    ...
                    <a href="javascript:void()" onclick="openNav('{{ route('media.slide') }}', 'source_code')"
                       class="btn btn-primary media-btn mt-2 p-2">@translate(Upload From Media) <i class="fa fa-cloud-upload ml-2"
