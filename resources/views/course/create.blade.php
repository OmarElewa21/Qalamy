...
<div class="card m-b-30">
    <h4 class="card-header" style="{{(App::isLocale('ar') ? 'text-align:right' : '')}}">@translate(Add new course)</h4>
    <div class="card-body mx-3">
        <form action="{{ route('course.store') }}" method="post"  enctype="multipart/form-data">
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-9">
                    ...
                    <br>
                      ...
                      @if (MediaActive())
                       {{-- media --}}
                      <a href="javascript:void()" onclick="openNav('{{ route('media.slide') }}', 'thumbnail')" class="btn btn-primary media-btn mt-2 p-2">@translate(Upload From Media) <i class="fa fa-cloud-upload ml-2" aria-hidden="true"></i> </a>
                      @endif
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-9" style="{{(App::isLocale('ar') ? 'text-align:right' : '')}}">
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-9">
                    <div class="bootstrap-tagsinput" style="{{(App::isLocale('ar') ? 'text-align:right' : '')}}">
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-9">
                  <div style="{{(App::isLocale('ar') ? 'text-align:right' : '')}}" class="switchery-list">
            ...
            <div id="auto_hide">
                ...
                <div class="form-group row">
                    ...
                    <div style="{{(App::isLocale('ar') ? 'text-align:right' : '')}}" class="col-lg-9">
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-8">
                    <button style="{{(App::isLocale('ar') ? 'float:right' : '')}}" type="submit" class="btn btn-primary">
