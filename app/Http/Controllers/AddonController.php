...
class AddonController extends Controller
{
    ...
    public function certificate($addon_name, $purchase_code)
    {
      ...
      try {
        ...
        $certificate->top_text = @translate('CERTIFICATE OR ACHIEVEMENT');
        $certificate->header_text = @translate('THIS CERTIFICATE IS PROUDLY PRESENTED TO');
        $certificate->footer_text = @translate('FOR THE SUCCESSFUL COMPLETION OF');
        $certificate->permissions = @translate('NO');
